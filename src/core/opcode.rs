                        ...
                        Mem16(pc + 1)
                            ...
                            .and_then(|imm16| {
                                let result = match self {
                                    ...
                                    Opcode::ADDSP(dst, _) => {
                                        format!("ADD {}, %{:+}", dst, signed_imm8)
                                    }

                                    Opcode::LD16(r, _) => format!("LD {}, %0x{:04x}", r, imm16),
                                    Opcode::LDImmMemSP(_, r) => {
                                        format!("LD (0x{:04x}), {}", imm16, r)
                                    }
                                    ...
                                    Opcode::LDHLMemImm(r, _) => {
                                        format!("LD {}, %0x{:02x}", r, imm8)
                                    }
                                    ...
                                    Opcode::LDHCMemA(_, r) => {
                                        format!("LDH ($FF00+{}), {}", imm8, r)
                                    }
                                    Opcode::LDHACMem(r, _) => {
                                        format!("LDH {}, ($FF00+{})", r, imm8)
                                    }
                                    Opcode::LDImmMemA(_, r) => {
                                        format!("LD ($0x{:04x}), {}", imm16, r)
                                    }
                                    Opcode::LDAImmMem(r, _) => {
                                        format!("LD {}, ($0x{:04x})", r, imm16)
                                    }
